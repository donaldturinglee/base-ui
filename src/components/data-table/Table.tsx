...
const classes = {
    ...
    edges: "[&_tr>*:first-child:not([data-cell-skeleton])]:ps-[var(--base-size-16)] [&_tr>*:first-child_[data-cell-skeleton-item]]:ps-[var(--base-size-16)] [&_tr>*:last-child:not([data-cell-skeleton])]:pe-[var(--base-size-16)] [&_tr>*:last-child_[data-cell-skeleton-item]]:pe-[var(--base-size-16)]",
    hover: "[&_tbody_tr:hover>*:not([data-cell-skeleton])]:bg-[var(--control-transparent-background-color-hover)]",
};
        ...
        >
            <table
                ...
                className={classNames(
                    classes.root,
                    classes.cellPadding[cellPadding],
                    classes.borders,
                    classes.corners,
                    classes.edges,
                    classes.hover,
