    ...
    const control = (
        <ul
            ...
            className={classNames(
                ...
                classes.size[size],
                classes.fullWidth,
                classes.fullWidthNarrow,
                classes.fullWidthRegular,
                classes.fullWidthWide,
                classes.replaced,
                className,
            )}
