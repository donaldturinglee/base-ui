...
const classes = {
    ...
    button: "relative size-[var(--text-input-action-size)] p-[var(--base-size-4)] bg-transparent [color:var(--foreground-color-muted)] hover:[color:var(--foreground-color-default)] focus:[color:var(--foreground-color-default)]",
