...
// The box a part of the footer is drawn in. Every part can be taken off the screen at
...
function PageFooterRegion<As extends React.ElementType = "div">(
    props: PageFooterChildProps<As>,
    ...
    const {
        ...
        hidden,
        ...rest
    } = props as PageFooterChildProps<"div">;
...
export default fixedForwardRef(PageFooterRegion);
