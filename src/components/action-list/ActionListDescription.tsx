...
const classes = {
    root: "[color:var(--foreground-color-muted)] [font-size:var(--text-body-size-small)] leading-[var(--text-body-line-height-small)] [font-weight:var(--base-text-weight-normal)]",
