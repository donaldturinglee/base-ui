...
const classes = {
    ...
    root: "flex content-start gap-[var(--stack-gap,var(--stack-gap-normal))]",
    gap: {
        none: "[--stack-gap:0]",
    ...
    // `px` and `py` resolve to the logical padding axes, so these override `padding` on one axis
    paddingBlock: {
        none: "py-0",
    ...
    return (
        <Component
            ...
            className={classNames(
                ...
                paddingBlock && classes.paddingBlock[paddingBlock],
                paddingInline && classes.paddingInline[paddingInline],
                className,
            )}
