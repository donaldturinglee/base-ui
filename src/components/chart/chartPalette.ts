...
// The names a colour can be asked for by, so that a chart is written in the terms the design
// system already uses rather than in whatever hex the marks happen to need. The five hues name
// the data; the rest name the furniture drawn around it, which a chart has to hand to recharts
// as attribute values rather than leave to the stylesheet
export const CHART_COLORS = {
    blue: CHART_SERIES_COLORS[0],
    orange: CHART_SERIES_COLORS[1],
    purple: CHART_SERIES_COLORS[2],
    green: CHART_SERIES_COLORS[3],
    pink: CHART_SERIES_COLORS[4],
    grid: "var(--border-color-muted)",
    axis: "var(--border-color-default)",
    surface: "var(--background-color-default)",
    foreground: "var(--foreground-color-default)",
    muted: CHART_OVERFLOW_COLOR,
};
