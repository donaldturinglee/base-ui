...
const classes = {
    ...
    root: "relative grid place-content-center size-[var(--base-size-16)] m-0 mt-[var(--base-size-2)] cursor-pointer appearance-none rounded-[var(--border-radius-full)] bg-[var(--background-color-default)] border-solid border-[length:var(--border-width-thin)] border-[color:var(--control-border-color-emphasis)] transition-[background-color,border-color] duration-[var(--motion-duration-micro)] ease-[var(--motion-easing-hover)]",
