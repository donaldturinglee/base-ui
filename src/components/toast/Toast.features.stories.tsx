...
const classes = {
    ...
    custom: "flex w-full items-center gap-[var(--base-size-8)] rounded-[var(--border-radius-large)] bg-[var(--background-color-upsell-muted)] p-[var(--base-size-12)] [box-shadow:var(--shadow-floating-small)]",
};
