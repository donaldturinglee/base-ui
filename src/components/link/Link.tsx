...
const classes = {
    root: "[color:var(--foreground-color-accent)] no-underline [text-underline-offset:0.05rem] hover:underline",
    ...
    muted: "[color:var(--foreground-color-muted)] hover:[color:var(--foreground-color-accent)] hover:no-underline",
};
