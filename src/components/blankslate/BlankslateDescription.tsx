...
const classes = {
    ...
    root: "text-center [text-wrap:balance] [margin-inline:0] [margin-block:var(--blankslate-description-margin-block,0)] [font:var(--blankslate-description-text)] [color:var(--foreground-color-muted)]",
};
