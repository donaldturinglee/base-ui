...
const classes = {
    ...
    root: "flex flex-col shrink-0 min-w-0",
    width: {
    ...
    // in a ScrollableRegion, which only becomes a landmark once it really does scroll
    sticky: "sticky top-0 h-screen overflow-auto",
    padding: {
        none: "p-0",
    ...
    spacing: "gap-[var(--page-sidebar-gap)]",
    gap: {
    ...
    return (
        <Component
            ...
            className={classNames(
                ...
                hasBorder && classes.border[position],
                className,
            )}
