...
// The box a part of the sidebar is drawn in. Every part can be taken off the screen at
...
function PageSidebarRegion<As extends React.ElementType = "div">(
    props: PageSidebarChildProps<As>,
    ...
    const {
        ...
        hidden,
        ...rest
    } = props as PageSidebarChildProps<"div">;
...
export default fixedForwardRef(PageSidebarRegion);
