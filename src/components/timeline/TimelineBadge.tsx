...
const timelineBadgeVariants = cva(
    ...
    "flex items-center justify-center shrink-0 overflow-hidden size-[var(--base-size-32)] me-[var(--base-size-8)] -ms-[15px] rounded-full border-solid border-[length:var(--border-width-thick)] border-background-default bg-[var(--timeline-badge-background-color,var(--background-color-muted))] text-foreground-muted",
    {
        variants: {
