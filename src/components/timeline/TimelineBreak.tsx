...
const classes = {
    ...
    root: "relative z-1 h-[var(--base-size-24)] m-0 ms-0 mb-[calc(-1_*_var(--base-size-16))] bg-[var(--background-color-default)] border-0 border-t-[length:var(--border-width-thicker)] border-t-[color:var(--border-color-default)]",
