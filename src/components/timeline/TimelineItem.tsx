...
const classes = {
    ...
    rail: "before:content-[''] before:absolute before:inset-y-0 before:start-0 before:block before:w-[var(--border-width-thick)] before:bg-border-muted",
    ...
    condensedBadge:
        "[&_[data-component='Timeline.Badge']]:h-[var(--base-size-16)] [&_[data-component='Timeline.Badge']]:my-[var(--base-size-8)] [&_[data-component='Timeline.Badge']]:border-0 [&_[data-component='Timeline.Badge']]:bg-background-default [&_[data-component='Timeline.Badge']]:text-foreground-muted",
    condensedAvatar:
