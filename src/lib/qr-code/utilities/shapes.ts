  ...
  switch (shape) {
    case "rounded": {
      ...
      return (
        ...
        innerRoundedRect(x + moduleSize, y + moduleSize, s - 2 * moduleSize, s - 2 * moduleSize, r * 0.5)
      );
    }
    case "dots": {
      const r = s / 2;
    ...
    case "extra-rounded": {
      ...
      return (
        outerRoundedRect(x, y, s, s, r) +
        innerRoundedRect(x + moduleSize, y + moduleSize, s - 2 * moduleSize, s - 2 * moduleSize, r * 0.6)
      );
    }
    case "classy": {
      const r = moduleSize * 1.5;
