 ...
 * Format: [totalCodewords, ecCodewordsPerBlock, group1Blocks,
 *          group1DataCW, group2Blocks, group2DataCW]
 */
...
/* eslint-disable max-len -- hand-aligned spec table, one row per version */
// prettier-ignore
